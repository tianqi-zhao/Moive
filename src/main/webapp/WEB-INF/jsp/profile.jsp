...
<head>
    <meta charset="utf-8"/>
    <title data-react-helmet="true">Moive</title>
                            ...
                            <div class="UserAvatarEditor ProfileHeader-avatar" style="top:-57px;margin-left: 20px;"
                                ...
                                <div class="UserAvatar" data-reactid="78">
                                    <img class="Avatar Avatar--large UserAvatar-inner" width="160" height="160"
                                         src="<%=basePath%>assets/img/user_avatar.jpg" srcset="<%=basePath%>assets/img/user_avatar.jpg 2x"
                                         data-reactid="79"/>
                                </div>
                            </div>
                                                    ...
                                                    <table width="100%" class="">
                                                        <tr class="item">
                                                            <td width="100" valign="top">
                                                                <a class="nbg" value="${item.movieid}" onclick='javascript:$.post("<%=path%>/Customer/Description",{id:$(this).attr("value")}, function (data) {
                                                  if (data=="success") {
                                                      location.href = "<%=path%>/MovieDescription"
                                                            ...
                                                            <td valign="top">
                                                                <div class="pl2">
                                                                    ...
                                                                    <a value="${item.movieid}" onclick='javascript:$.post("<%=path%>/Customer/Description",{id:$(this).attr("value")}, function (data) {
                                                  if (data=="success") {
                                                      location.href = "<%=path%>/MovieDescription"
                                                  } else {
                                                  }
                    ...
                    <div class="Profile-lightList" data-reactid="329">
                        ...
                        <c:if test="${sessionScope.TopDefaultMovie != null}">
                            <c:forEach var="item" items="${sessionScope.TopDefaultMovie}">
                                <a class="Profile-lightItem" onclick='javascript:$.post("<%=path%>/Customer/Description",{id:$(this).attr("value")}, function (data) {
            if (data=="success") {
                location.href = "<%=path%>/MovieDescription"
            } else {
            }
